                ...
                {complaints.map((complaint, index) => (
                    <li key={index}>
                        ...
                        <div className="complaint-images">
                            <div className="img-1">{complaint.photo && <img src={`https://new-smartgram-6mjh.vercel.app//${complaint.photo}`} alt="Complaint Issue" />}
                            </div>
                            <div className='img-2'>{complaint.idProof && <img src={`https://new-smartgram-6mjh.vercel.app//${complaint.idProof}`} alt="ID Proof" />}
                            </div></div>
                    </li>
                ))}
            </ul>
